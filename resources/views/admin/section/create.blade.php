    ...
    <div class="main-container container-xxl" id="container">
        <div class="middle-content container-xxl p-0">
            ...
            <x-widgets._w-breadcrumb>
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('general.common.create') }}</li>
            </x-widgets._w-breadcrumb>
            <!-- /BREADCRUMB -->
                        ...
                        <form action="{{ route('admin.section.store') }}" method="POST">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('fixed_key') is-invalid @enderror" name="fixed_key" id="sFixedKey" placeholder="Fixed key">
                                    @error('fixed_key')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
