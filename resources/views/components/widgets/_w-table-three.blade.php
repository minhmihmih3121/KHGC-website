                ...
                <!-- <thead>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="td-content product-name"><img
                                        src="{{Vite::asset('resources/images/product-headphones.jpg')}}" alt="product">
                        ...
                        <tr>
                          ...
                          <div class="td-content product-name"><img
                                        src="{{Vite::asset('resources/images/product-shoes.jpg')}}" alt="product">
                                    <div class="align-self-center">
                        ...
                        <tr>
                            <td>
                                <div class="td-content product-name"><img
                                        src="{{Vite::asset('resources/images/product-watch.jpg')}}" alt="product">
                                    <div class="align-self-center">
                        ...
                        <tr>
                            <td>
                                <div class="td-content product-name"><img
                                        src="{{Vite::asset('resources/images/product-laptop.jpg')}}" alt="product">
                                    <div class="align-self-center">
                        ...
                        <tr>
                            <td>
                                <div class="td-content product-name"><img
                                        src="{{Vite::asset('resources/images/product-camera.jpg')}}" alt="product">
                                    <div class="align-self-center">
